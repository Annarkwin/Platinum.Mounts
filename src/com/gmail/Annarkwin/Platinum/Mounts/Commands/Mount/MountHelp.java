...
public class MountHelp extends PlatinumCommand implements HelpCommand
{

	public MountHelp( String name, String permission, boolean player, String description, String usage )
	{
