...
public class CommandMount implements CommandExecutor, MainCommand {
	...
	private final Subcommand[] subcommands = {new MountRide(this), new MountClaim(this), new MountRelease(this), new MountHelp(this), new MountHealth(this), new MountJump(this), new MountSpeed(this)};
